...
OID_PRE="$(curl -sX POST "${FHIR_BASE}/Observation" \
  ...
  -d '{"resourceType":"Observation","status":"preliminary","category":[{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/observation-category","code":"laboratory"}]}],"code":{"coding":[{"system":"http://loinc.org","code":"718-7"}]},"subject":{"reference":"Patient/ca-100"},"effectiveDateTime":"2025-01-08T19:50:00Z","valueQuantity":{"value":141,"unit":"g/L"}}' | jq -r '.id')"
...
OID_FIN="$(curl -sX POST "${FHIR_BASE}/Observation" \
  -H "Authorization: Bearer $(token)" -H "Content-Type: application/fhir+json" \
  -d '{"resourceType":"Observation","status":"final","category":[{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/observation-category","code":"laboratory"}]}],"code":{"coding":[{"system":"http://loinc.org","code":"718-7"}]},"subject":{"reference":"Patient/ca-100"},"effectiveDateTime":"2025-01-08T19:55:00Z","valueQuantity":{"value":138,"unit":"g/L"}}' | jq -r '.id')"
